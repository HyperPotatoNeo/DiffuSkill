...
def visualize_kitchen_mixed_latents(args):
    ...
    for traj_idx in range(1, len(terminals)):
        ...
        # Microwave
        if dataset['observations'][start_idx + 70, 22] < -0.6:
            tasks[traj_idx - 1] = 1

        # Kettle
        elif abs(dataset['observations'][start_idx + 70, 24] - 0.7) < 0.1:
            tasks[traj_idx - 1] = 0
    ...
    if zero_shape == 366:
        print('Zero (Blue) is Microwave')
    elif one_shape == 366:
        print('One (Red) is Microwave')
    else:
        print('Two (Yellow) is Microwave')

    if zero_shape == 179:
        print('Zero (Blue) is Kettle')
    elif one_shape == 179:
        print('One (Red) is Kettle')
    else:
        print('Two (Yellow) is Kettle')

    if zero_shape == 56:
        print('Zero (Blue) is Burner')
    elif one_shape == 56:
        print('One (Red) is Burner')
    else:
        print('Two (Yellow) is Burner')
